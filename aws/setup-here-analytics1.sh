...
FILESTOGO+=" setup-there-common.sh setup-there-analytics1.sh fix-ec2-mail.py ec2-send-memory-metrics.py cron-mail-to-sns.py"
...
ssh $SSHARGS -t $SSHDEST "/home/ec2-user/setup-there-common.sh ${AWSCRED_KEYID} ${AWSCRED_SECRET} ${AWS_CRON_SNS_TOPIC} && /home/ec2-user/setup-there-analytics1.sh"
