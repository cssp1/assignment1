...
# see http://stackoverflow.com/questions/7458391/python-multiple-linear-regression-using-ols-code-with-specific-data
# SP3RDPARTY : ols.py : CC-by-sa License
...
class ols:
    ...
    def summary(self):
        ...
        print "OLS regression of " + self.y_varnm, 'on', self.x_varnm[1:]
        print '# obs:               %5.0f' % self.nobs
        print 'variable                    coefficient     std. Error    t-statistic    p'
        print '================================================================================='
        for i in range(len(self.x_varnm)):
            print '''% -20s          % -5.6f     % -5.6f     % -5.6f     % -5.6f''' % tuple([self.x_varnm[i],self.b[i],self.se[i],self.t[i],self.p[i]])
        print '================================================================================='
#        print 'Models stats                         Residual stats'
#        print '================================================================================='
        print 'R-squared            % -5.6f         Adjusted R-squared  % -5.6f' % tuple([self.R2, self.R2adj])
