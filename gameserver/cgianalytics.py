...
EVENT_STAGES = {
    ...
    'mf2': [{'ui_name': 'Karl (tutorial25)', 'key': 'tutorial25', 'difficulties': ['normal'], 'check_levels': range(1,25+1)},
            #{'ui_name': 'Guardian (guardian)', 'key': 'guardian', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,32+1)},
            #{'ui_name': 'Guardian (wk90 rerun)', 'key': 'guardian2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,32+1)},
            {'ui_name': 'Guardian (wk110 rerun)', 'key': 'guardian3', 'difficulties': ['normal'], 'check_levels': range(1,32+1)},
            #{'ui_name': 'Harvest (harvest)', 'key': 'harvest', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, #range(1,24+1)},
            #{'ui_name': 'Harvest (wk92 rerun)', 'key': 'harvest2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1), 'attempts': True},
            #{'ui_name': 'Red Devil (wk89)', 'key': 'devil1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,32+1)},
            #{'ui_name': 'Red Devil (wk94 rerun)', 'key': 'devil2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,32+1), 'attempts': True},
            #{'ui_name': 'Turncoat (wk91 turncoat)', 'key': 'turncoat1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1), 'attempts': True},
            #{'ui_name': 'Turncoat (wk96 turncoat)', 'key': 'turncoat2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1), 'attempts': True},
            #{'ui_name': 'Collection (wk93 collection)', 'key': 'collection1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # 'check_levels': range(1,8+1), 'attempts': True},
            {'ui_name': 'Predation (wk111 collection)', 'key': 'collection2', 'difficulties': ['normal'], 'check_levels': range(1,8+1), 'attempts': True},
            #{'ui_name': 'Prophecy (wk95 prophecy)', 'key': 'prophecy1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # 'check_levels': range(1,50+1), 'attempts': True},
            {'ui_name': 'Warmonger (wk114 prophecy)', 'key': 'prophecy2', 'difficulties': ['normal'], 'check_levels': range(1,50+1), 'attempts': True},
            #{'ui_name': 'Extinction (wk97 extinction)', 'key': 'extinction1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, #'check_levels': range(1,20+1),'attempts': True
            #{'ui_name': 'Vectus Siege Event (wk98 defense_waa)', 'key': 'defense_waa1', 'difficulties': ['normal'], 'check_levels': range(0,-1)},#'check_levels': range(1,50+1),'attempts': True},
            {'ui_name': 'Vectus Siege Event (wk113 defense_waa rerun)', 'key': 'defense_waa2', 'difficulties': ['normal'], 'check_levels': range(1,50+1),'attempts': True},
            #{'ui_name': 'Monstrous (wk99 monstrous)', 'key': 'monstrous1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,50+1),'attempts': True},
            #{'ui_name': 'Cyrus Siege Event (wk100 defense_wab)', 'key': 'defense_wab1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, #'check_levels': range(1,48+1),'attempts': True},
            #{'ui_name': 'Devious (wk101 devious)', 'key': 'devious1', 'difficulties': ['normal'], 'check_levels': range(0,-1) }, #'check_levels': range(1,32+1),'attempts': True},
            #{'ui_name': 'Gluto Siege Event (wk107 defense_wad)', 'key': 'defense_wad1', 'difficulties': ['normal'], 'check_levels': range(1,40+1), 'attempts': True},
            #{'ui_name': 'Dark Herald (wk103 herald)', 'key': 'herald1', 'difficulties': ['normal'], 'check_levels': range(1,32+1),'attempts': True},
            #{'ui_name': 'Alder Siege Event (wk102 defense_waf)', 'key': 'defense_waf1', 'difficulties': ['normal'], 'check_levels': range(1,36+1),'attempts': True},
            #{'ui_name': 'Ruckus (wk105 ruckus)', 'key': 'ruckus1', 'difficulties': ['normal'], 'check_levels': range(1,32+1),'attempts': True},
            #{'ui_name': 'Tyrant (wk108 tyrant)', 'key': 'tyrant1', 'difficulties': ['normal'], 'check_levels': range(1,32+1),'attempts': True},
    ],
    'tr': [#{'ui_name': 'Hamilton', 'key': 'hamilton', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1)
           #{'ui_name': 'Hamilton (rerun)', 'key': 'hamilton2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1)},
           #{'ui_name': 'Hamilton (second rerun)', 'key': 'hamilton3', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1)},
           #{'ui_name': 'Hamilton (wk101 rerun)', 'key': 'hamilton4', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1), 'attempts':True},
           {'ui_name': 'Hamilton (wk118 rerun)', 'key': 'hamilton5', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts':True}, # range(1,24+1), 'attempts':True},
           {'ui_name': 'Hamilton (wk150 rerun)', 'key': 'hamilton6', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts':True}, # range(1,24+1), 'attempts':True},
           #{'ui_name': 'Ambush', 'key': 'ambush', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,60+1)},
           #{'ui_name': 'Ambush (rerun)', 'key': 'ambush2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,60+1)},
           #{'ui_name': 'Ambush (wk103 rerun)', 'key': 'ambush3', 'difficulties': ['normal'], 'check_levels': range(1,60+1), 'attempts':True}, # range(1,60+1), 'attempts':True},
           {'ui_name': 'Ambush (wk120 rerun)', 'key': 'ambush4', 'difficulties': ['normal'], 'check_levels': range(1,60+1), 'attempts':True}, # range(1,60+1), 'attempts':True},
           {'ui_name': 'Ambush (wk152 rerun)', 'key': 'ambush5', 'difficulties': ['normal'], 'check_levels': range(1,60+1), 'attempts':True}, # range(1,60+1), 'attempts':True},
           #{'ui_name': 'War Pirate', 'key': 'pirate', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,60+1)},
           #{'ui_name': 'War Pirate (rerun)', 'key': 'pirate2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,60+1)},
           #{'ui_name': 'War Pirate (second rerun)', 'key': 'pirate3', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,60+1)},
           #{'ui_name': 'War Pirate (wk93 rerun)', 'key': 'pirate4', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1, 60+1), 'attempts':True},
           #{'ui_name': 'War Pirate (wk110 rerun)', 'key': 'pirate5', 'difficulties': ['normal'], 'check_levels': range(1, 60+1), 'attempts':True}, # range(1, 60+1), 'attempts':True},
           {'ui_name': 'War Pirate (wk126 rerun)', 'key': 'pirate6', 'difficulties': ['normal'], 'check_levels': range(1, 60+1), 'attempts':True}, # range(1, 60+1), 'attempts':True},
           {'ui_name': 'War Pirate (wk142 rerun)', 'key': 'pirate7', 'difficulties': ['normal'], 'check_levels': range(1, 60+1), 'attempts':True}, # range(1, 60+1), 'attempts':True},
           #{'ui_name': 'The Hot Gates (xerxes)', 'key': 'xerxes', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,50+1)},
           #{'ui_name': 'The Hot Gates (xerxes) (rerun)', 'key': 'xerxes2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,50+1)},
           #{'ui_name': 'The Hot Gates (xerxes) (wk89 rerun)', 'key': 'xerxes3', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,50+1)},
           #{'ui_name': 'The Hot Gates (xerxes) (wk105 rerun)', 'key': 'xerxes4', 'difficulties': ['normal'], 'check_levels': range(1,50+1), 'attempts':True}, # range(1,50+1), 'attempts':True},
           #{'ui_name': 'The Hot Gates (xerxes) (wk122 rerun)', 'key': 'xerxes5', 'difficulties': ['normal'], 'check_levels': range(1,50+1), 'attempts':True},
           {'ui_name': 'The Hot Gates (xerxes) (wk138 rerun)', 'key': 'xerxes6', 'difficulties': ['normal'], 'check_levels': range(1,50+1), 'attempts':True},
           #{'ui_name': 'The Merchant (giancarlo)', 'key': 'giancarlo', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,40+1)},
           #{'ui_name': 'The Merchant (giancarlo) (rerun)', 'key': 'giancarlo2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,40+1)},
           #{'ui_name': 'The Merchant (giancarlo) (second rerun)', 'key': 'giancarlo3', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,40+1)},
           #{'ui_name': 'The Merchant (giancarlo) (wk95 rerun)', 'key': 'giancarlo4', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,40+1), 'attempts':True},
           #{'ui_name': 'The Merchant (giancarlo) (wk112 rerun)', 'key': 'giancarlo5', 'difficulties': ['normal'], 'check_levels': range(1,40+1), 'attempts':True}, # range(1,40+1), 'attempts':True},
           {'ui_name': 'The Merchant (giancarlo) (wk128 rerun)', 'key': 'giancarlo6', 'difficulties': ['normal'], 'check_levels': range(1,40+1), 'attempts':True}, # range(1,40+1), 'attempts':True},
           {'ui_name': 'The Merchant (giancarlo) (wk144 rerun)', 'key': 'giancarlo7', 'difficulties': ['normal'], 'check_levels': range(1,40+1), 'attempts':True}, # range(1,40+1), 'attempts':True},
           #{'ui_name': 'Guerilla (maximilien)', 'key': 'maximilien', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1)},
           #{'ui_name': 'Guerilla (maximilien) (wk 91 rerun)', 'key': 'maximilien2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1)}, 'attempts': True
           #{'ui_name': 'Guerilla (maximilien) (wk 108 rerun)', 'key': 'maximilien3', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts': True}, # range(1,24+1)}, 'attempts': True},
           #{'ui_name': 'Guerilla (maximilien) (wk 124 rerun)', 'key': 'maximilien3', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts': True}, # range(1,24+1)}, 'attempts': True},
           {'ui_name': 'Guerilla (maximilien) (wk 140 rerun)', 'key': 'maximilien5', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts': True}, # range(1,24+1)},
           #{'ui_name': 'Poacher (kim)', 'key': 'kim', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1)},
           #{'ui_name': 'Poacher (kim) (rerun)', 'key': 'kim2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1)},
           #{'ui_name': 'Poacher (wk97 rerun)', 'key': 'kim3', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1), 'attempts':True},
           #{'ui_name': 'Poacher (wk114 kim4)', 'key': 'kim4', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1), 'attempts':True},
           {'ui_name': 'Poacher (wk130 kim5)', 'key': 'kim5', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1), 'attempts':True},
           {'ui_name': 'Poacher (wk146 kim6)', 'key': 'kim6', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1), 'attempts':True},
           #{'ui_name': 'Virus (segvec)', 'key': 'segvec', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1)},
           #{'ui_name': 'Virus (segvec) (rerun)', 'key': 'segvec2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1)},
           #{'ui_name': 'Virus (wk99 segvec) (rerun)', 'key': 'segvec3', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1), 'attempts':True},
           #{'ui_name': 'Virus (wk116 segvec4) (rerun)', 'key': 'segvec4', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1), 'attempts':True},
           {'ui_name': 'Virus (wk132 segvec5) (rerun)', 'key': 'segvec5', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1), 'attempts':True},
           {'ui_name': 'Virus (wk148 segvec6) (rerun)', 'key': 'segvec6', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,25+1), 'attempts':True},
           #{'ui_name': 'Inquisition (cyclops)', 'key': 'cyclops', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,50+1)},
           #{'ui_name': 'Onslaught (wk92 cyclops)', 'key': 'cyclops2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1, 50+1), 'attempts':True},
           #{'ui_name': 'Incursion (wk109 cyclops3)', 'key': 'cyclops3', 'difficulties': ['normal'], 'check_levels': range(1,50+1), 'attempts':True}, # range(1, 50+1), 'attempts':True},
           {'ui_name': 'Cyclops (wk127 cyclops5)', 'key': 'cyclops5', 'difficulties': ['normal'], 'check_levels': range(1,50+1), 'attempts':True}, # range(1, 50+1), 'attempts':True},
           #{'ui_name': 'Toxic (queen)', 'key': 'queen', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,32+1)},
           #{'ui_name': 'Outbreak (wk96 queen)', 'key': 'queen2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,32+1), 'attempts':True},
           {'ui_name': 'Epidemic (wk115 queen)', 'key': 'queen3', 'difficulties': ['normal'], 'check_levels': range(1,32+1), 'attempts':True}, # range(1,32+1), 'attempts':True},
           {'ui_name': 'Epidemic (wk133 queen)', 'key': 'queen4', 'difficulties': ['normal'], 'check_levels': range(1,32+1), 'attempts':True}, # range(1,32+1),
           #{'ui_name': 'Savage (warlord)', 'key': 'warlord1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,32+1)},
           #{'ui_name': 'Vicious (wk98 warlord)', 'key': 'warlord2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,32+1), 'attempts':True},
           {'ui_name': 'Ruthless (wk117 warlord3)', 'key': 'warlord3', 'difficulties': ['normal'], 'check_levels': range(1,32+1), 'attempts':True},
           {'ui_name': 'Ruthless (wk135 warlord4)', 'key': 'warlord4', 'difficulties': ['normal'], 'check_levels': range(1,32+1), 'attempts':True},
           #{'ui_name': 'Fugitive (fugitive)', 'key': 'fugitive1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1)},
           #{'ui_name': 'Renegade (wk100 fugitive2)', 'key': 'fugitive2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1), 'attempts':True},
           {'ui_name': 'Renegade (wk119 fugitive3)', 'key': 'fugitive3', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts':True},
           {'ui_name': 'Renegade (wk137 fugitive4)', 'key': 'fugitive4', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts':True},
           #{'ui_name': 'Piper (piper)', 'key': 'piper1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1)},
           #{'ui_name': 'Cutthroat (wk102 piper2)', 'key': 'piper2', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,24+1), 'attempts':True},
           #{'ui_name': 'Cutthroat (wk121 piper3)', 'key': 'piper3', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts':True},
           {'ui_name': 'Cutthroat (wk139,157,177 piper4)', 'key': 'piper4', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts':True},
           #{'ui_name': 'Rogue (wk90 rogue)', 'key': 'rogue1', 'difficulties': ['normal'], 'check_levels': range(0,-1)}, # range(1,8+1), 'attempts':True},
           #{'ui_name': 'Blowback (wk104 rogue2)', 'key': 'rogue2', 'difficulties': ['normal'], 'check_levels': range(1,8+1), 'attempts':True}, # range(1,8+1), 'attempts':True},
           #{'ui_name': 'Blowback (wk123 rogue3)', 'key': 'rogue3', 'difficulties': ['normal'], 'check_levels': range(1,8+1), 'attempts':True}, # range(1,8+1), 'attempts':True},
           {'ui_name': 'Blowback (wk123 rogue4)', 'key': 'rogue4', 'difficulties': ['normal'], 'check_levels': range(1,8+1), 'attempts':True}, # range(1,32+1), 'attempts':True},
    ...
    'bfm': [{'ui_name': 'Chaos Theory (wk100 giancarlo1)', 'key': 'ambush1', 'difficulties': ['normal'], 'check_levels': range(1,40+1), 'attempts': True},
            {'ui_name': 'Merciless (wk100 segvec1)', 'key': 'segvec1', 'difficulties': ['normal'], 'check_levels': range(1,25+1), 'attempts': True},
            {'ui_name': 'Rain of Fire (wk114 hamilton1)', 'key': 'hamilton1', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts': True},
            {'ui_name': 'Hunter (wk115 kim1)', 'key': 'kim1', 'difficulties': ['normal'], 'check_levels': range(1,25+1), 'attempts': True},
            {'ui_name': 'Entrapment (wk116 ambush1)', 'key': 'ambush1', 'difficulties': ['normal'], 'check_levels': range(1,60+1), 'attempts': True},
            {'ui_name': 'Portal (wk117 xerxes1)', 'key': 'xerxes1', 'difficulties': ['normal'], 'check_levels': range(1,50+1), 'attempts': True},
            {'ui_name': 'Empress (wk118 queen1)', 'key': 'queen1', 'difficulties': ['normal'], 'check_levels': range(1,32+1), 'attempts': True},
            {'ui_name': 'Uprising (wk119 maximilen1)', 'key': 'maximilien1', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts': True},
            {'ui_name': 'Relentless (wk120 warlord1)', 'key': 'warlord1', 'difficulties': ['normal'], 'check_levels': range(1,32+1), 'attempts':True},
            {'ui_name': 'Marauder (wk121 pirate)', 'key': 'pirate1', 'difficulties': ['normal'], 'check_levels': range(1,60+1), 'attempts': True},
            {'ui_name': 'Convict (wk122 fugitive)', 'key': 'fugitive1', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts': True},
            {'ui_name': 'Outcast (wk124 piper)', 'key': 'piper1', 'difficulties': ['normal'], 'check_levels': range(1,24+1), 'attempts': True},
            {'ui_name': 'Traitor (wk126 rogue)', 'key': 'rogue1', 'difficulties': ['normal'], 'check_levels': range(1,8+1), 'attempts': True},
            {'ui_name': 'Lethal (wk128 murderous)', 'key': 'murderous1', 'difficulties': ['normal'], 'check_levels': range(1,12+1), 'attempts': True},
            {'ui_name': 'Exile (wk132 nomad)', 'key': 'nomad1', 'difficulties': ['normal'], 'check_levels': range(1,32+1), 'attempts': True},
            {'ui_name': 'Madness (wk134 fanatic)', 'key': 'fanatic1', 'difficulties': ['normal'], 'check_levels': range(1,32+1), 'attempts': True},
            ],
    'sg': []
    }
EVENT_DIFFICULTIES = {
...
CUSTOM_STAGES = {
    ...
    #{'name': 'E133A Inquisition (Cyclops): Conquered 1+ hive', 'func': lambda user: user.get('ai_cyclops_conquests',0) >= 1 },
    #{'name': 'E133B Inquisition (Cyclops): Conquered 2+ hives', 'func': lambda user: user.get('ai_cyclops_conquests',0) >= 2 },
    #{'name': 'E133C Inquisition (Cyclops): Conquered 5+ hives', 'func': lambda user: user.get('ai_cyclops_conquests',0) >= 5 },
    #{'name': 'E133D Inquisition (Cyclops): Conquered 10+ hives', 'func': lambda user: user.get('ai_cyclops_conquests',0) >= 10 },
    #{'name': 'E134A Toxic (Mafia Queen): Conquered 1+ hive', 'func': lambda user: user.get('ai_queen_conquests',0) >= 1 },
    #{'name': 'E134B Toxic (Mafia Queen): Conquered 2+ hives', 'func': lambda user: user.get('ai_queen_conquests',0) >= 2 },
    #{'name': 'E134C Toxic (Mafia Queen): Conquered 5+ hives', 'func': lambda user: user.get('ai_queen_conquests',0) >= 5 },
    #{'name': 'E134D Toxic (Mafia Queen): Conquered 10+ hives', 'func': lambda user: user.get('ai_queen_conquests',0) >= 10 },
    #{'name': 'E135A Savage (Warlord): Conquered 1+ hive', 'func': lambda user: user.get('ai_warlord1_conquests',0) >= 1 },
    #{'name': 'E135B Savage (Warlord): Conquered 2+ hives', 'func': lambda user: user.get('ai_warlord1_conquests',0) >= 2 },
    #{'name': 'E135C Savage (Warlord): Conquered 5+ hives', 'func': lambda user: user.get('ai_warlord1_conquests',0) >= 5 },
    #{'name': 'E135D Savage (Warlord): Conquered 10+ hives', 'func': lambda user: user.get('ai_warlord1_conquests',0) >= 10 },
    #{'name': 'E136A Fugitive: Conquered 1+ hive', 'func': lambda user: user.get('ai_fugitive1_conquests',0) >= 1 },
    #{'name': 'E136B Fugitive: Conquered 2+ hives', 'func': lambda user: user.get('ai_fugitive1_conquests',0) >= 2 },
    #{'name': 'E136C Fugitive: Conquered 5+ hives', 'func': lambda user: user.get('ai_fugitive1_conquests',0) >= 5 },
    #{'name': 'E136D Fugitive: Conquered 10+ hives', 'func': lambda user: user.get('ai_fugitive1_conquests',0) >= 10 },
    {'name': 'E136G Completed FASCAM Shield Set', 'func': lambda user: user.get('achievement:aoefire_shield_infantry_complete',0) >= 1 },
    #{'name': 'E137A Piper: Conquered 1+ hive', 'func': lambda user: user.get('ai_piper1_conquests',0) >= 1 },
    #{'name': 'E137B Piper: Conquered 2+ hives', 'func': lambda user: user.get('ai_piper1_conquests',0) >= 2 },
    #{'name': 'E137C Piper: Conquered 5+ hives', 'func': lambda user: user.get('ai_piper1_conquests',0) >= 5 },
    #{'name': 'E137D Piper: Conquered 10+ hives', 'func': lambda user: user.get('ai_piper1_conquests',0) >= 10 },
    #{'name': 'E138A Ambush: Conquered 1+ hive', 'func': lambda user: user.get('ai_ambush2_conquests',0) >= 1 },
    #{'name': 'E138B Ambush: Conquered 2+ hives', 'func': lambda user: user.get('ai_ambush2_conquests',0) >= 2 },
    #{'name': 'E138C Ambush: Conquered 5+ hives', 'func': lambda user: user.get('ai_ambush2_conquests',0) >= 5 },
    #{'name': 'E138D Ambush: Conquered 10+ hives', 'func': lambda user: user.get('ai_ambush2_conquests',0) >= 10 },
    #{'name': 'E139A Rogue: Conquered 1+ hive', 'func': lambda user: user.get('ai_rogue_conquests',0) >= 1 },
    #{'name': 'E139B Rogue: Conquered 2+ hives', 'func': lambda user: user.get('ai_rogue_conquests',0) >= 2 },
    #{'name': 'E139C Rogue: Conquered 5+ hives', 'func': lambda user: user.get('ai_rogue_conquests',0) >= 5 },
    #{'name': 'E139D Rogue: Conquered 10+ hives', 'func': lambda user: user.get('ai_rogue_conquests',0) >= 10 },
    #{'name': 'E140A Piper (wk90): Conquered 1+ hive', 'func': lambda user: user.get('ai_piper2_conquests',0) >= 1 },
    #{'name': 'E140B Piper (wk90): Conquered 2+ hives', 'func': lambda user: user.get('ai_piper2_conquests',0) >= 2 },
    #{'name': 'E140C Piper (wk90): Conquered 5+ hives', 'func': lambda user: user.get('ai_piper2_conquests',0) >= 5 },
    #{'name': 'E140D Piper (wk90): Conquered 10+ hives', 'func': lambda user: user.get('ai_piper2_conquests',0) >= 10 },
    #{'name': 'E141A Onslaught (Cyclops): Conquered 1+ hive', 'func': lambda user: user.get('ai_cyclops2_conquests',0) >= 1 },
    #{'name': 'E141B Onslaught (Cyclops): Conquered 2+ hives', 'func': lambda user: user.get('ai_cyclops2_conquests',0) >= 2 },
    #{'name': 'E141C Onslaught (Cyclops): Conquered 5+ hives', 'func': lambda user: user.get('ai_cyclops2_conquests',0) >= 5 },
    #{'name': 'E142A Murderous: Conquered 1+ hive', 'func': lambda user: user.get('ai_murderous1_conquests',0) >= 1 },
    #{'name': 'E142B Murderous: Conquered 2+ hives', 'func': lambda user: user.get('ai_murderous1_conquests',0) >= 2 },
    #{'name': 'E142C Murderous: Conquered 5+ hives', 'func': lambda user: user.get('ai_murderous1_conquests',0) >= 5 },
    #{'name': 'E142D Murderous: Conquered 10+ hives', 'func': lambda user: user.get('ai_murderous1_conquests',0) >= 10 },
    #{'name': 'E145A Outbreak (wk96): Conquered 1+ hive', 'func': lambda user: user.get('ai_queen2_conquests',0) >= 1 },
    #{'name': 'E145B Outbreak (wk96): Conquered 2+ hives', 'func': lambda user: user.get('ai_queen2_conquests',0) >= 2 },
    #{'name': 'E145C Outbreak (wk96): Conquered 5+ hives', 'func': lambda user: user.get('ai_queen2_conquests',0) >= 5 },
    #{'name': 'E145D Outbreak (wk96): Conquered 10+ hives', 'func': lambda user: user.get('ai_queen2_conquests',0) >= 10 },
    #{'name': 'E146A Gashi (wk96): Conquered 1+ hive', 'func': lambda user: user.get('ai_gashi1_conquests',0) >= 1 },
    #{'name': 'E146B Gashi (wk96): Conquered 2+ hives', 'func': lambda user: user.get('ai_gashi1_conquests',0) >= 2 },
    #{'name': 'E146C Gashi (wk96): Conquered 5+ hives', 'func': lambda user: user.get('ai_gashi1_conquests',0) >= 5 },
    #{'name': 'E146D Gashi (wk96): Conquered 10+ hives', 'func': lambda user: user.get('ai_gashi1_conquests',0) >= 10 },
    #{'name': 'E147A Vicious (wk98): Conquered 1+ hive', 'func': lambda user: user.get('ai_warlord2_conquests',0) >= 1 },
    #{'name': 'E147B Vicious (wk98): Conquered 2+ hives', 'func': lambda user: user.get('ai_warlord2_conquests',0) >= 2 },
    #{'name': 'E147C Vicious (wk98): Conquered 5+ hives', 'func': lambda user: user.get('ai_warlord2_conquests',0) >= 5 },
    #{'name': 'E147D Vicious (wk98): Conquered 10+ hives', 'func': lambda user: user.get('ai_warlord2_conquests',0) >= 10 },
    #{'name': 'E148A Renegade: Conquered 1+ hive', 'func': lambda user: user.get('ai_fugitive2_conquests',0) >= 1 },
    #{'name': 'E148B Renegade: Conquered 2+ hives', 'func': lambda user: user.get('ai_fugitive2_conquests',0) >= 2 },
    #{'name': 'E148C Renegade: Conquered 5+ hives', 'func': lambda user: user.get('ai_fugitive2_conquests',0) >= 5 },
    #{'name': 'E148D Renegade: Conquered 10+ hives', 'func': lambda user: user.get('ai_fugitive2_conquests',0) >= 10 },
    #{'name': 'E149A Cutthroat (wk102): Conquered 1+ hive', 'func': lambda user: user.get('ai_piper2_conquests',0) >= 1 },
    #{'name': 'E149B Cutthroat (wk102): Conquered 2+ hives', 'func': lambda user: user.get('ai_piper2_conquests',0) >= 2 },
    #{'name': 'E149C Cutthroat (wk102): Conquered 5+ hives', 'func': lambda user: user.get('ai_piper2_conquests',0) >= 5 },
    #{'name': 'E149D Cutthroat (wk102): Conquered 10+ hives', 'func': lambda user: user.get('ai_piper2_conquests',0) >= 10 },
    #{'name': 'E150A Ambush (wk103): Conquered 1+ hive', 'func': lambda user: user.get('ai_ambush3_conquests',0) >= 1 },
    #{'name': 'E150B Ambush (wk103): Conquered 2+ hives', 'func': lambda user: user.get('ai_ambush3_conquests',0) >= 2 },
    #{'name': 'E150C Ambush (wk103): Conquered 5+ hives', 'func': lambda user: user.get('ai_ambush3_conquests',0) >= 5 },
    #{'name': 'E150D Ambush (wk103): Conquered 10+ hives', 'func': lambda user: user.get('ai_ambush3_conquests',0) >= 10 },
    #{'name': 'E151A Blowback (wk104): Conquered 1+ hive', 'func': lambda user: user.get('ai_rogue2_conquests',0) >= 1 },
    #{'name': 'E151B Blowback (wk104): Conquered 2+ hives', 'func': lambda user: user.get('ai_rogue2_conquests',0) >= 2 },
    #{'name': 'E151C Blowback (wk104): Conquered 5+ hives', 'func': lambda user: user.get('ai_rogue2_conquests',0) >= 5 },
    #{'name': 'E151D Blowback (wk104): Conquered 10+ hives', 'func': lambda user: user.get('ai_rogue2_conquests',0) >= 10 },
    #{'name': 'E152A Vendetta (wk106): Conquered 1+ hive', 'func': lambda user: user.get('ai_murderous2_conquests',0) >= 1 },
    #{'name': 'E152B Vendetta (wk106): Conquered 2+ hives', 'func': lambda user: user.get('ai_murderous2_conquests',0) >= 2 },
    #{'name': 'E152C Vendetta (wk106): Conquered 5+ hives', 'func': lambda user: user.get('ai_murderous2_conquests',0) >= 5 },
    #{'name': 'E152D Vendetta (wk106): Conquered 10+ hives', 'func': lambda user: user.get('ai_murderous2_conquests',0) >= 10 },
    #{'name': 'E154A Mandel (wk108): Conquered 1+ hive', 'func': lambda user: user.get('ai_mandel2_conquests',0) >= 1 },
    #{'name': 'E154B Mandel (wk108): Conquered 2+ hives', 'func': lambda user: user.get('ai_mandel2_conquests',0) >= 2 },
    #{'name': 'E154C Mandel (wk108): Conquered 5+ hives', 'func': lambda user: user.get('ai_mandel2_conquests',0) >= 5 },
    #{'name': 'E154D Mandel (wk108): Conquered 10+ hives', 'func': lambda user: user.get('ai_mandel2_conquests',0) >= 10 },
    #{'name': 'E155A Incursion (wk109): Conquered 1+ hive', 'func': lambda user: user.get('ai_cyclops3_conquests',0) >= 1 },
    #{'name': 'E155B Incursion (wk109): Conquered 2+ hives', 'func': lambda user: user.get('ai_cyclops3_conquests',0) >= 2 },
    #{'name': 'E155C Incursion (wk109): Conquered 5+ hives', 'func': lambda user: user.get('ai_cyclops3_conquests',0) >= 5 },
    #{'name': 'E155D Incursion (wk109): Conquered 10+ hives', 'func': lambda user: user.get('ai_cyclops3_conquests',0) >= 10 },
    #{'name': 'E156A Gashi (wk110): Conquered 1+ hive', 'func': lambda user: user.get('ai_gashi2_conquests',0) >= 1 },
    #{'name': 'E156B Gashi (wk110): Conquered 2+ hives', 'func': lambda user: user.get('ai_gashi2_conquests',0) >= 2 },
    #{'name': 'E156C Gashi (wk110): Conquered 5+ hives', 'func': lambda user: user.get('ai_gashi2_conquests',0) >= 5 },
    #{'name': 'E156D Gashi (wk110): Conquered 10+ hives', 'func': lambda user: user.get('ai_gashi2_conquests',0) >= 10 },
    #{'name': 'E157A Fanatic (wk111): Conquered 1+ hive', 'func': lambda user: user.get('ai_fanatic1_conquests',0) >= 1 },
    #{'name': 'E157B Fanatic (wk111): Conquered 2+ hives', 'func': lambda user: user.get('ai_fanatic1_conquests',0) >= 2 },
    #{'name': 'E157C Fanatic (wk111): Conquered 5+ hives', 'func': lambda user: user.get('ai_fanatic1_conquests',0) >= 5 },
    #{'name': 'E157D Fanatic (wk111): Conquered 10+ hives', 'func': lambda user: user.get('ai_fanatic1_conquests',0) >= 10 },
    #{'name': 'E158A Red Pole (wk112): Conquered 1+ hive', 'func': lambda user: user.get('ai_redpole1_conquests',0) >= 1 },
    #{'name': 'E158B Red Pole (wk112): Conquered 2+ hives', 'func': lambda user: user.get('ai_redpole1_conquests',0) >= 2 },
    #{'name': 'E158C Red Pole (wk112): Conquered 5+ hives', 'func': lambda user: user.get('ai_redpole1_conquests',0) >= 5 },
    #{'name': 'E158D Red Pole (wk112): Conquered 10+ hives', 'func': lambda user: user.get('ai_redpole1_conquests',0) >= 10 },
    {'name': 'E159A Berkman (wk114): Conquered 1+ hive', 'func': lambda user: user.get('ai_berkman3_conquests',0) >= 1 },
    {'name': 'E159B Berkman (wk114): Conquered 2+ hives', 'func': lambda user: user.get('ai_berkman3_conquests',0) >= 2 },
    {'name': 'E159C Berkman (wk114): Conquered 5+ hives', 'func': lambda user: user.get('ai_berkman3_conquests',0) >= 5 },
    {'name': 'E159D Berkman (wk114): Conquered 10+ hives', 'func': lambda user: user.get('ai_berkman3_conquests',0) >= 10 },
    {'name': 'E160A Mandel (wk116): Conquered 1+ hive', 'func': lambda user: user.get('ai_mandel3_conquests',0) >= 1 },
    {'name': 'E160B Mandel (wk116): Conquered 2+ hives', 'func': lambda user: user.get('ai_mandel3_conquests',0) >= 2 },
    {'name': 'E160C Mandel (wk116): Conquered 5+ hives', 'func': lambda user: user.get('ai_mandel3_conquests',0) >= 5 },
    {'name': 'E160D Mandel (wk116): Conquered 10+ hives', 'func': lambda user: user.get('ai_mandel3_conquests',0) >= 10 },
    {'name': 'E161A Nomad (wk113): Conquered 1+ hive', 'func': lambda user: user.get('ai_nomad1_conquests',0) >= 1 },
    {'name': 'E162B Nomad (wk113): Conquered 2+ hives', 'func': lambda user: user.get('ai_nomad1_conquests',0) >= 2 },
    {'name': 'E163C Nomad (wk113): Conquered 5+ hives', 'func': lambda user: user.get('ai_nomad1_conquests',0) >= 5 },
    {'name': 'E164D Nomad (wk113): Conquered 10+ hives', 'func': lambda user: user.get('ai_nomad1_conquests',0) >= 10 },
    {'name': 'E165A Ruthless (wk98): Conquered 1+ hive', 'func': lambda user: user.get('ai_warlord3_conquests',0) >= 1 },
    {'name': 'E165B Ruthless (wk98): Conquered 2+ hives', 'func': lambda user: user.get('ai_warlord3_conquests',0) >= 2 },
    {'name': 'E165C Ruthless (wk98): Conquered 5+ hives', 'func': lambda user: user.get('ai_warlord3_conquests',0) >= 5 },
    {'name': 'E165D Ruthless (wk98): Conquered 10+ hives', 'func': lambda user: user.get('ai_warlord3_conquests',0) >= 10 },
    {'name': 'E166A Epidemic (wk115): Conquered 1+ hive', 'func': lambda user: user.get('ai_queen3_conquests',0) >= 1 },
    {'name': 'E166B Epidemic (wk115): Conquered 2+ hives', 'func': lambda user: user.get('ai_queen3_conquests',0) >= 2 },
    {'name': 'E166C Epidemic (wk115): Conquered 5+ hives', 'func': lambda user: user.get('ai_queen3_conquests',0) >= 5 },
    {'name': 'E166D Epidemic (wk115): Conquered 10+ hives', 'func': lambda user: user.get('ai_queen3_conquests',0) >= 10 },
    {'name': 'E167A Renegade (wk119): Conquered 1+ hive', 'func': lambda user: user.get('ai_fugitive3_conquests',0) >= 1 },
    {'name': 'E167B Renegade (wk119): Conquered 2+ hives', 'func': lambda user: user.get('ai_fugitive3_conquests',0) >= 2 },
    {'name': 'E167C Renegade (wk119): Conquered 5+ hives', 'func': lambda user: user.get('ai_fugitive3_conquests',0) >= 5 },
    {'name': 'E167D Renegade (wk119): Conquered 10+ hives', 'func': lambda user: user.get('ai_fugitive3_conquests',0) >= 10 },
    {'name': 'E168A Blowback (wk123): Conquered 1+ hive', 'func': lambda user: user.get('ai_rogue3_conquests',0) >= 1 },
    {'name': 'E168B Blowback (wk123): Conquered 2+ hives', 'func': lambda user: user.get('ai_rogue3_conquests',0) >= 2 },
    {'name': 'E168C Blowback (wk123): Conquered 5+ hives', 'func': lambda user: user.get('ai_rogue3_conquests',0) >= 5 },
    {'name': 'E168D Blowback (wk123): Conquered 10+ hives', 'func': lambda user: user.get('ai_rogue3_conquests',0) >= 10 },
    {'name': 'E169A Cutthroat (wk121): Conquered 1+ hive', 'func': lambda user: user.get('ai_piper3_conquests',0) >= 1 },
    {'name': 'E169B Cutthroat (wk121): Conquered 2+ hives', 'func': lambda user: user.get('ai_piper3_conquests',0) >= 2 },
    {'name': 'E169C Cutthroat (wk121): Conquered 5+ hives', 'func': lambda user: user.get('ai_piper3_conquests',0) >= 5 },
    {'name': 'E169D Cutthroat (wk121): Conquered 10+ hives', 'func': lambda user: user.get('ai_piper3_conquests',0) >= 10 },
    {'name': 'E170A Murderous (wk125): Conquered 1+ hive', 'func': lambda user: user.get('ai_murderous3_conquests',0) >= 1 },
    {'name': 'E170B Murderous (wk125): Conquered 2+ hives', 'func': lambda user: user.get('ai_murderous3_conquests',0) >= 2 },
    {'name': 'E170C Murderous (wk125): Conquered 5+ hives', 'func': lambda user: user.get('ai_murderous3_conquests',0) >= 5 },
    {'name': 'E170D Murderous (wk125): Conquered 10+ hives', 'func': lambda user: user.get('ai_murderous3_conquests',0) >= 10 },
    {'name': 'E171A Cyclops (wk127): Conquered 1+ hive', 'func': lambda user: user.get('ai_cyclops4_conquests',0) >= 1 },
    {'name': 'E171B Cyclops (wk127): Conquered 2+ hives', 'func': lambda user: user.get('ai_cyclops4_conquests',0) >= 2 },
    {'name': 'E171C Cyclops (wk127): Conquered 5+ hives', 'func': lambda user: user.get('ai_cyclops4_conquests',0) >= 5 },
    {'name': 'E171D Cyclops (wk127): Conquered 10+ hives', 'func': lambda user: user.get('ai_cyclops4_conquests',0) >= 10 },
    {'name': 'E172A Fanatic (wk129): Conquered 1+ hive', 'func': lambda user: user.get('ai_fanatic2_conquests',0) >= 1 },
    {'name': 'E172B Fanatic (wk129): Conquered 2+ hives', 'func': lambda user: user.get('ai_fanatic2_conquests',0) >= 2 },
    {'name': 'E172C Fanatic (wk129): Conquered 5+ hives', 'func': lambda user: user.get('ai_fanatic2_conquests',0) >= 5 },
    {'name': 'E172D Fanatic (wk129): Conquered 10+ hives', 'func': lambda user: user.get('ai_fanatic2_conquests',0) >= 10 },
    {'name': 'E173A Nomad (wk131): Conquered 1+ hive', 'func': lambda user: user.get('ai_nomad2_conquests',0) >= 1 },
    {'name': 'E173B Nomad (wk131): Conquered 2+ hives', 'func': lambda user: user.get('ai_nomad2_conquests',0) >= 2 },
    {'name': 'E173C Nomad (wk131): Conquered 5+ hives', 'func': lambda user: user.get('ai_nomad2_conquests',0) >= 5 },
    {'name': 'E173D Nomad (wk131): Conquered 10+ hives', 'func': lambda user: user.get('ai_nomad2_conquests',0) >= 10 },
    {'name': 'E174A Warlord (wk135): Conquered 1+ hive', 'func': lambda user: user.get('ai_warlord4_conquests',0) >= 1 },
    {'name': 'E174B Warlord (wk135): Conquered 2+ hives', 'func': lambda user: user.get('ai_warlord4_conquests',0) >= 2 },
    {'name': 'E174C Warlord (wk135): Conquered 5+ hives', 'func': lambda user: user.get('ai_warlord4_conquests',0) >= 5 },
    {'name': 'E174D Warlord (wk135): Conquered 10+ hives', 'func': lambda user: user.get('ai_warlord4_conquests',0) >= 10 },
    {'name': 'E175A Renegade (wk137): Conquered 1+ hive', 'func': lambda user: user.get('ai_fugitive4_conquests',0) >= 1 },
    {'name': 'E175B Renegade (wk137): Conquered 2+ hives', 'func': lambda user: user.get('ai_fugitive4_conquests',0) >= 2 },
    {'name': 'E175C Renegade (wk137): Conquered 5+ hives', 'func': lambda user: user.get('ai_fugitive4_conquests',0) >= 5 },
    {'name': 'E175D Renegade (wk137): Conquered 10+ hives', 'func': lambda user: user.get('ai_fugitive4_conquests',0) >= 10 },
    {'name': 'E176A Epidemic (wk133): Conquered 1+ hive', 'func': lambda user: user.get('ai_queen4_conquests',0) >= 1 },
    {'name': 'E176B Epidemic (wk133): Conquered 2+ hives', 'func': lambda user: user.get('ai_queen4_conquests',0) >= 2 },
    {'name': 'E176C Epidemic (wk133): Conquered 5+ hives', 'func': lambda user: user.get('ai_queen4_conquests',0) >= 5 },
    {'name': 'E176D Epidemic (wk133): Conquered 10+ hives', 'func': lambda user: user.get('ai_queen4_conquests',0) >= 10 },
    {'name': 'E177A Blowback (wk141,159,175): Conquered 1+ hive', 'func': lambda user: user.get('ai_rogue4_conquests',0) >= 1 },
    {'name': 'E177B Blowback (wk141,159,175)): Conquered 2+ hives', 'func': lambda user: user.get('ai_rogue4_conquests',0) >= 2 },
    {'name': 'E177C Blowback (wk141,159,175)): Conquered 5+ hives', 'func': lambda user: user.get('ai_rogue4_conquests',0) >= 5 },
    {'name': 'E177D Blowback (wk141,159,175)): Conquered 10+ hives', 'func': lambda user: user.get('ai_rogue4_conquests',0) >= 10 },
    {'name': 'E178A Cutthroat (wk139,157,177): Conquered 1+ hive', 'func': lambda user: user.get('ai_piper4_conquests',0) >= 1 },
    ...
    {'name': 'E200B Red Pole (Murdock wk117): Conquered 2+ hives', 'func': lambda user: user.get('ai_redpole1_conquests',0) >= 2 },
    {'name': 'E200C Red Pole (Murdock wk117): Conquered 5+ hives', 'func': lambda user: user.get('ai_redpole1_conquests',0) >= 5 },
    {'name': 'E200D Red Pole (Murdock wk117): Conquered 10+ hives', 'func': lambda user: user.get('ai_redpole1_conquests',0) >= 10 },
    {'name': 'E201A Empress (wk118 queen1): Conquered 1+ hive', 'func': lambda user: user.get('ai_queen1_conquests',0) >= 1 },
    {'name': 'E201A Empress (wk118 queen1): Conquered 5+ hives', 'func': lambda user: user.get('ai_queen1_conquests',0) >= 5 },
    {'name': 'E201A Empress (wk118 queen1): Conquered 10+ hives', 'func': lambda user: user.get('ai_queen1_conquests',0) >= 10 },
    {'name': 'E201A Warlord (Relentless wk120): Conquered 1+ hive', 'func': lambda user: user.get('ai_warlord1_conquests',0) >= 1 },
    {'name': 'E201C Warlord (Relentless wk120): Conquered 5+ hives', 'func': lambda user: user.get('ai_warlord1_conquests',0) >= 5 },
    {'name': 'E201D Warlord (Relentless wk120): Conquered 10+ hives', 'func': lambda user: user.get('ai_warlord1_conquests',0) >= 10 },
    {'name': 'E202A Fugitive (Convict wk122): Conquered 1+ hive', 'func': lambda user: user.get('ai_fugitive1_conquests',0) >= 1 },
    {'name': 'E202C Fugitive (Convict wk122): Conquered 5+ hives', 'func': lambda user: user.get('ai_fugitive1_conquests',0) >= 5 },
    {'name': 'E202D Fugitive (Convict wk122): Conquered 10+ hives', 'func': lambda user: user.get('ai_fugitive1_conquests',0) >= 10 },
    {'name': 'E205A Piper (Outcast wk124): Conquered 1+ hive', 'func': lambda user: user.get('ai_piper1_conquests',0) >= 1 },
    {'name': 'E205C Piper (Outcast wk124): Conquered 5+ hives', 'func': lambda user: user.get('ai_piper1_conquests',0) >= 5 },
    {'name': 'E205D Piper (Outcast wk124): Conquered 10+ hives', 'func': lambda user: user.get('ai_piper1_conquests',0) >= 10 },
    {'name': 'E206A Rogue (Traitor wk126): Conquered 1+ hive', 'func': lambda user: user.get('ai_rogue1_conquests',0) >= 1 },
    {'name': 'E206C Rogue (Traitor wk126): Conquered 5+ hives', 'func': lambda user: user.get('ai_rogue1_conquests',0) >= 5 },
    {'name': 'E206D Rogue (Traitor wk126): Conquered 10+ hives', 'func': lambda user: user.get('ai_rogue1_conquests',0) >= 10 },
    {'name': 'E207A Murderous (Lethal wk128): Conquered 1+ hive', 'func': lambda user: user.get('ai_murderous1_conquests',0) >= 1 },
    {'name': 'E207C Murderous (Lethal wk128): Conquered 5+ hives', 'func': lambda user: user.get('ai_murderous1_conquests',0) >= 5 },
    {'name': 'E207D Murderous (Lethal wk128): Conquered 10+ hives', 'func': lambda user: user.get('ai_murderous1_conquests',0) >= 10 },
    {'name': 'E208A Cyclops (Prince wk130): Conquered 1+ hive', 'func': lambda user: user.get('ai_cyclops1_conquests',0) >= 1 },
    {'name': 'E208C Cyclops (Prince wk130): Conquered 5+ hives', 'func': lambda user: user.get('ai_cyclops1_conquests',0) >= 5 },
    {'name': 'E208D Cyclops (Prince wk130): Conquered 10+ hives', 'func': lambda user: user.get('ai_cyclops1_conquests',0) >= 10 },
    {'name': 'E209A Nomad (Exile wk132): Conquered 1+ hive', 'func': lambda user: user.get('ai_nomad1_conquests',0) >= 1 },
    {'name': 'E209C Nomad (Exile wk132): Conquered 5+ hives', 'func': lambda user: user.get('ai_nomad1_conquests',0) >= 5 },
    {'name': 'E209D Nomad (Exile wk132): Conquered 10+ hives', 'func': lambda user: user.get('ai_nomad1_conquests',0) >= 10 },
    {'name': 'E210A Fanatic (Madness wk134): Conquered 1+ hive', 'func': lambda user: user.get('ai_fanatic1_conquests',0) >= 1 },
    {'name': 'E210C Fanatic (Madness wk134): Conquered 5+ hives', 'func': lambda user: user.get('ai_fanatic1_conquests',0) >= 5 },
    {'name': 'E210D Fanatic (Madness wk134): Conquered 10+ hives', 'func': lambda user: user.get('ai_fanatic1_conquests',0) >= 10 },
    ],
    'sg': [],
    'mf': [
    {'name': 'E80 Conquered V1 Kirat L1', 'func': lambda user: user.get('ai_kirat_progress',0) >= 1 },
#    {'name': 'E81 Conquered Old Kirat L10', 'func': lambda user: user.get('ai_kirat_progress',0) >= 10 },
#    {'name': 'E82 Conquered Old Kirat L15', 'func': lambda user: user.get('ai_kirat_progress',0) >= 15 },
#    {'name': 'E83 Conquered Old Kirat L20', 'func': lambda user: user.get('ai_kirat_progress',0) >= 20 },
    {'name': 'E84 Conquered V1 Kirat L25', 'func': lambda user: user.get('ai_kirat_progress',0) >= 25 },

    {'name': 'E85 Conquered V1 Kirat L1', 'func': lambda user: user.get('ai_kirat2_progress',0) >= 1 },
#    {'name': 'E86 Conquered New Kirat L10', 'func': lambda user: user.get('ai_kirat2_progress',0) >= 10 },
#    {'name': 'E87 Conquered New Kirat L15', 'func': lambda user: user.get('ai_kirat2_progress',0) >= 15 },
#    {'name': 'E88 Conquered New Kirat L20', 'func': lambda user: user.get('ai_kirat2_progress',0) >= 20 },
    {'name': 'E89 Conquered V2 Kirat L25', 'func': lambda user: user.get('ai_kirat2_progress',0) >= 25 },
    {'name': 'E90 Unlocked Curiosity', 'mandatory_field': 'tech', 'func': lambda user: user['tech'].get('curiosity_production',0) > 0 },

    {'name': 'E90A Beat V1 Phantom attack  L1', 'func': lambda user: user.get('ai_phantom_progress',0) >= 1 },
#    {'name': 'E90B Beat Phantom attack L10', 'func': lambda user: user.get('ai_phantom_progress',0) >= 10 },
#    {'name': 'E90C Beat Phantom attack L15', 'func': lambda user: user.get('ai_phantom_progress',0) >= 15 },
#    {'name': 'E90D Beat Phantom attack L20', 'func': lambda user: user.get('ai_phantom_progress',0) >= 20 },
    {'name': 'E90E Beat V1 Phantom Attack L25', 'func': lambda user: user.get('ai_phantom_progress',0) >= 25 },

    {'name': 'E91A Beat V2 Phantom2 attack  L1', 'func': lambda user: user.get('ai_phantom2_progress',0) >= 1 },
#    {'name': 'E91B Beat Phantom2 attack  L5', 'func': lambda user: user.get('ai_phantom2_progress',0) >= 5 },
#    {'name': 'E91C Beat Phantom2 attack L10', 'func': lambda user: user.get('ai_phantom2_progress',0) >= 10 },
#    {'name': 'E91D Beat Phantom2 attack L15', 'func': lambda user: user.get('ai_phantom2_progress',0) >= 15 },
#    {'name': 'E91E Beat Phantom2 attack L20', 'func': lambda user: user.get('ai_phantom2_progress',0) >= 20 },
    {'name': 'E91F Beat V2 Phantom2 Attack L25', 'func': lambda user: user.get('ai_phantom2_progress',0) >= 25 },
    {'name': 'E91X Unlocked Phantom', 'mandatory_field': 'tech', 'func': lambda user: user['tech'].get('phantom_production',0) > 0 },

    {'name': 'E97A Conquered Vell Jomil L1',  'func': lambda user: user.get('ai_radiation_progress',0) >= 1 },
#    {'name': 'E97B Conquered Vell Jomil L10', 'func': lambda user: user.get('ai_radiation_progress',0) >= 10 },
#    {'name': 'E97C Conquered Vell Jomil L15', 'func': lambda user: user.get('ai_radiation_progress',0) >= 15 },
#    {'name': 'E97D Conquered Vell Jomil L20', 'func': lambda user: user.get('ai_radiation_progress',0) >= 20 },
    {'name': 'E97E Conquered Vell Jomil L25', 'func': lambda user: user.get('ai_radiation_progress',0) >= 25 },

    {'name': 'E100 Won Ice Event L1',  'func': lambda user: user.get('ai_ice_progress',0) >= 1 },
#    {'name': 'E101 Won Ice Event L10', 'func': lambda user: user.get('ai_ice_progress',0) >= 10 },
#    {'name': 'E102 Won Ice Event L15', 'func': lambda user: user.get('ai_ice_progress',0) >= 15 },
#    {'name': 'E103 Won Ice Event L20', 'func': lambda user: user.get('ai_ice_progress',0) >= 20 },
    {'name': 'E104 Won Ice Event L25', 'func': lambda user: user.get('ai_ice_progress',0) >= 25 },

    {'name': 'E120 Won Arsenal Event L1',  'func': lambda user: user.get('ai_arsenal_progress',0) >= 1 },
    {'name': 'E121 Won Arsenal Event L10', 'func': lambda user: user.get('ai_arsenal_progress',0) >= 10 },
    {'name': 'E122 Won Arsenal Event L15', 'func': lambda user: user.get('ai_arsenal_progress',0) >= 15 },
    {'name': 'E123 Won Arsenal Event L20', 'func': lambda user: user.get('ai_arsenal_progress',0) >= 20 },
    {'name': 'E124 Won Arsenal Event L25', 'func': lambda user: user.get('ai_arsenal_progress',0) >= 25 },

    {'name': 'E130A Crash: Conquered 1+ Crash hive',  'func': lambda user: user.get('ai_crash_consquests',0) >= 1 },
    {'name': 'E130B Crash: Conquered 2+ Crash hives',  'func': lambda user: user.get('ai_crash_consquests',0) >= 2 },
    {'name': 'E130C Crash: Conquered 5+ Crash hives',  'func': lambda user: user.get('ai_crash_consquests',0) >= 5 },
    {'name': 'E131B Prisoner: Conquered 1+ Prisoner hive',  'func': lambda user: user.get('ai_prisoner_conquests',0) >= 1 },
    {'name': 'E131C Prisoner: Conquered 2+ Prisoner hives',  'func': lambda user: user.get('ai_prisoner_conquests',0) >= 2 },
    {'name': 'E131D Prisoner: Conquered 5+ Prisoner hives',  'func': lambda user: user.get('ai_prisoner_conquests',0) >= 5 },
    {'name': 'E131D Prisoner: Conquered 10+ Prisoner hives',  'func': lambda user: user.get('ai_prisoner_conquests',0) >= 10 },
    {'name': 'E131D Prisoner: Conquered 20+ Prisoner hives',  'func': lambda user: user.get('ai_prisoner_conquests',0) >= 20 },
    {'name': 'E132B Kingpin: Conquered 1+ Kingpin hive',  'func': lambda user: user.get('ai_kingpin_conquests',0) >= 1 },
    {'name': 'E132C Kingpin: Conquered 2+ Kingpin hives',  'func': lambda user: user.get('ai_kingpin_conquests',0) >= 2 },
    {'name': 'E132D Kingpin: Conquered 5+ Kingpin hives',  'func': lambda user: user.get('ai_kingpin_conquests',0) >= 5 },
    {'name': 'E132D Kingpin: Conquered 10+ Kingpin hives',  'func': lambda user: user.get('ai_kingpin_conquests',0) >= 10 },
    {'name': 'E132D Kingpin: Conquered 20+ Kingpin hives',  'func': lambda user: user.get('ai_kingpin_conquests',0) >= 20 },
    {'name': 'E133B Mutiny: Conquered 1+ Mutiny hive',  'func': lambda user: user.get('ai_mutiny_conquests',0) >= 1 },
    {'name': 'E133C Mutiny: Conquered 2+ Mutiny hives',  'func': lambda user: user.get('ai_mutiny_conquests',0) >= 2 },
    {'name': 'E133D Mutiny: Conquered 5+ Mutiny hives',  'func': lambda user: user.get('ai_mutiny_conquests',0) >= 5 },
    {'name': 'E133D Mutiny: Conquered 10+ Mutiny hives',  'func': lambda user: user.get('ai_mutiny_conquests',0) >= 10 },
    {'name': 'E133D Mutiny: Conquered 20+ Mutiny hives',  'func': lambda user: user.get('ai_mutiny_conquests',0) >= 20 },
    {'name': 'E134A Tokens: Got Incendiary Missiles prize',  'func': lambda user: user.get('item:tactical_napalm:purchased',0) >= 1 },
    {'name': 'E134B Tokens: Got Frost Missile prize',  'func': lambda user: user.get('item:tactical_frost:purchased',0) >= 1 },
    {'name': 'E134C Tokens: Got Battle Heal prize',  'func': lambda user: user.get('item:instant_combat_repair:purchased',0) >= 1 },
    {'name': 'E134D Tokens: Got Travel Speed Boost prize',  'func': lambda user: user.get('item:travel_speed_boost_50pct_1h:purchased',0) >= 1 },
    {'name': 'E134E Tokens: Got Gravity Missile prize',  'func': lambda user: user.get('item:tactical_gravity:purchased',0) >= 1 },
    {'name': 'E134F Tokens: Got All Damage Low Boost prize',  'func': lambda user: user.get('item:all_damage_boost_5pct:purchased',0) >= 1 },
    {'name': 'E134G Tokens: Got All Damage Medium Boost prize',  'func': lambda user: user.get('item:travel_speed_boost_50pct_1h:purchased',0) >= 1 },
    {'name': 'E134H Tokens: Got Rover Cold Shield prize',  'func': lambda user: user.get('item:rover_cold_medium:purchased',0) >= 1 },
    {'name': 'E134I Tokens: Got Gunship Cold Shield prize',  'func': lambda user: user.get('item:gunship_cold_medium:purchased',0) >= 1 },
    {'name': 'E134J Tokens: Got Transport Cold Shield prize',  'func': lambda user: user.get('item:transport_cold_medium:purchased',0) >= 1 },
    {'name': 'E134K Tokens: Got Curiosity Blueprint prize',  'func': lambda user: user.get('item:curiosity_blueprint:purchased',0) >= 1 },
    {'name': 'E134L Tokens: Got Phantom Blueprint prize',  'func': lambda user: user.get('item:phantom_blueprint:purchased',0) >= 1 },
    {'name': 'E134M Tokens: Got Inferno Blueprint prize',  'func': lambda user: user.get('item:inferno_blueprint:purchased',0) >= 1 },
    {'name': 'E134N Tokens: Got Hellfire Blueprint prize',  'func': lambda user: user.get('item:hellfire_blueprint:purchased',0) >= 1 },
    {'name': 'E134O Tokens: Got Frost Tank Blueprint prize',  'func': lambda user: user.get('item:frost_tank_blueprint:purchased',0) >= 1 },
    {'name': 'E134P Tokens: Got Gravity Tank Blueprint prize',  'func': lambda user: user.get('item:gravity_tank_blueprint:purchased',0) >= 1 },

    ],
    'mf2': [
    {'name': 'E50A Guardian: Conquered 1+ hive', 'func': lambda user: user.get('ai_guardian1_conquests',0) >= 1 },
    {'name': 'E50B Guardian: Conquered 2+ hives', 'func': lambda user: user.get('ai_guardian1_conquests',0) >= 2 },
    {'name': 'E50C Guardian: Conquered 5+ hives', 'func': lambda user: user.get('ai_guardian1_conquests',0) >= 5 },
    {'name': 'E50D Guardian: Conquered 10+ hives', 'func': lambda user: user.get('ai_guardian1_conquests',0) >= 10 },
    {'name': 'E51A Tonca: Conquered 1+ hive', 'func': lambda user: user.get('ai_tonca1_conquests',0) >= 1 },
    {'name': 'E51B Tonca: Conquered 2+ hives', 'func': lambda user: user.get('ai_tonca1_conquests',0) >= 2 },
    {'name': 'E51C Tonca: Conquered 5+ hives', 'func': lambda user: user.get('ai_tonca1_conquests',0) >= 5 },
    {'name': 'E51D Tonca: Conquered 10+ hives', 'func': lambda user: user.get('ai_tonca1_conquests',0) >= 10 },
    {'name': 'E52A Khronic: Conquered 1+ hive', 'func': lambda user: user.get('ai_khronic1_conquests',0) >= 1 },
    {'name': 'E52B Khronic: Conquered 2+ hives', 'func': lambda user: user.get('ai_khronic1_conquests',0) >= 2 },
    {'name': 'E52C Khronic: Conquered 5+ hives', 'func': lambda user: user.get('ai_khronic1_conquests',0) >= 5 },
    {'name': 'E52D Khronic: Conquered 10+ hives', 'func': lambda user: user.get('ai_khronic1_conquests',0) >= 10 },
    {'name': 'E53A Wilder: Conquered 1+ hive', 'func': lambda user: user.get('ai_wilder1_conquests',0) >= 1 },
    {'name': 'E53B Wilder: Conquered 2+ hives', 'func': lambda user: user.get('ai_wilder1_conquests',0) >= 2 },
    {'name': 'E53C Wilder: Conquered 5+ hives', 'func': lambda user: user.get('ai_wilder1_conquests',0) >= 5 },
    {'name': 'E53D Wilder: Conquered 10+ hives', 'func': lambda user: user.get('ai_wilder1_conquests',0) >= 10 },
    {'name': 'E54A Guardian (wk90): Conquered 1+ hive', 'func': lambda user: user.get('ai_guardian2_conquests',0) >= 1 },
    {'name': 'E54B Guardian (wk90): Conquered 2+ hives', 'func': lambda user: user.get('ai_guardian2_conquests',0) >= 2 },
    {'name': 'E54C Guardian (wk90): Conquered 5+ hives', 'func': lambda user: user.get('ai_guardian2_conquests',0) >= 5 },
    {'name': 'E54D Guardian (wk90): Conquered 10+ hives', 'func': lambda user: user.get('ai_guardian2_conquests',0) >= 10 },
    {'name': 'E55A Turncoat (wk91): Conquered 1+ hive', 'func': lambda user: user.get('ai_turncoat1_conquests',0) >= 1 },
    {'name': 'E55B Turncoat (wk91): Conquered 2+ hives', 'func': lambda user: user.get('ai_turncoat1_conquests',0) >= 2 },
    {'name': 'E55C Turncoat (wk91): Conquered 5+ hives', 'func': lambda user: user.get('ai_turncoat1_conquests',0) >= 5 },
    {'name': 'E55D Turncoat (wk91): Conquered 10+ hives', 'func': lambda user: user.get('ai_turncoat1_conquests',0) >= 10 },
    {'name': 'E56A Khronic (wk92) : Conquered 1+ hive', 'func': lambda user: user.get('ai_khronic2_conquests',0) >= 1 },
    {'name': 'E56B Khronic (wk92) : Conquered 2+ hives', 'func': lambda user: user.get('ai_khronic2_conquests',0) >= 2 },
    {'name': 'E56C Khronic (wk92) : Conquered 5+ hives', 'func': lambda user: user.get('ai_khronic2_conquests',0) >= 5 },
    {'name': 'E56D Khronic (wk92) : Conquered 10+ hives', 'func': lambda user: user.get('ai_khronic2_conquests',0) >= 10 },
    {'name': 'E57A Collection (wk92) : Conquered 1+ hive', 'func': lambda user: user.get('ai_collection1_conquests',0) >= 1 },
    {'name': 'E57B Collection (wk93) : Conquered 2+ hives', 'func': lambda user: user.get('ai_collection1_conquests',0) >= 2 },
    {'name': 'E57C Collection (wk93) : Conquered 5+ hives', 'func': lambda user: user.get('ai_collection1_conquests',0) >= 5 },
    {'name': 'E57D Collection (wk93) : Conquered 10+ hives', 'func': lambda user: user.get('ai_collection1_conquests',0) >= 10 },
    {'name': 'E58A Tonca (wk93): Conquered 1+ hive', 'func': lambda user: user.get('ai_tonca2_conquests',0) >= 1 },
    {'name': 'E58B Tonca (wk93): Conquered 2+ hives', 'func': lambda user: user.get('ai_tonca2_conquests',0) >= 2 },
    {'name': 'E58C Tonca (wk93): Conquered 5+ hives', 'func': lambda user: user.get('ai_tonca2_conquests',0) >= 5 },
    {'name': 'E57D Tonca (wk93): Conquered 10+ hives', 'func': lambda user: user.get('ai_tonca2_conquests',0) >= 10 },
    {'name': 'E59A Wilder: Conquered 1+ hive', 'func': lambda user: user.get('ai_wilder2_conquests',0) >= 1 },
    {'name': 'E59B Wilder: Conquered 2+ hives', 'func': lambda user: user.get('ai_wilder2_conquests',0) >= 2 },
    {'name': 'E59C Wilder: Conquered 5+ hives', 'func': lambda user: user.get('ai_wilder2_conquests',0) >= 5 },
    {'name': 'E59D Wilder: Conquered 10+ hives', 'func': lambda user: user.get('ai_wilder2_conquests',0) >= 10 },
    {'name': 'E60A Prophecy: Conquered 1+ hive', 'func': lambda user: user.get('ai_prophecy1_conquests',0) >= 1 },
    {'name': 'E60B Prophecy: Conquered 2+ hives', 'func': lambda user: user.get('ai_prophecy1_conquests',0) >= 2 },
    {'name': 'E60C Prophecy: Conquered 5+ hives', 'func': lambda user: user.get('ai_prophecy1_conquests',0) >= 5 },
    {'name': 'E60D Prophecy: Conquered 10+ hives', 'func': lambda user: user.get('ai_prophecy1_conquests',0) >= 10 },
    {'name': 'E61A Turncoat (wk96): Conquered 1+ hive', 'func': lambda user: user.get('ai_turncoat2_conquests',0) >= 1 },
    {'name': 'E61B Turncoat (wk96): Conquered 2+ hives', 'func': lambda user: user.get('ai_turncoat2_conquests',0) >= 2 },
    {'name': 'E61C Turncoat (wk96): Conquered 5+ hives', 'func': lambda user: user.get('ai_turncoat2_conquests',0) >= 5 },
    {'name': 'E61D Turncoat (wk96): Conquered 10+ hives', 'func': lambda user: user.get('ai_turncoat2_conquests',0) >= 10 },
    {'name': 'E62A Extinction (wk97): Conquered 1+ hive', 'func': lambda user: user.get('ai_extinction1_conquests',0) >= 1 },
    {'name': 'E62B Extinction (wk97): Conquered 2+ hives', 'func': lambda user: user.get('ai_extinction1_conquests',0) >= 2 },
    {'name': 'E62C Extinction (wk97): Conquered 5+ hives', 'func': lambda user: user.get('ai_extinction1_conquests',0) >= 5 },
    {'name': 'E62D Extinction (wk97): Conquered 10+ hives', 'func': lambda user: user.get('ai_extinction1_conquests',0) >= 10 },
    {'name': 'E63A Monstrous (wk99): Conquered 1+ hive', 'func': lambda user: user.get('ai_monstrous1_conquests',0) >= 1 },
    {'name': 'E63B Monstrous (wk99): Conquered 2+ hives', 'func': lambda user: user.get('ai_monstrous1_conquests',0) >= 2 },
    {'name': 'E63C Monstrous (wk99): Conquered 5+ hives', 'func': lambda user: user.get('ai_monstrous1_conquests',0) >= 5 },
    {'name': 'E63D Monstrous (wk99): Conquered 10+ hives', 'func': lambda user: user.get('ai_monstrous1_conquests',0) >= 10 },
    {'name': 'E64A Devious (wk101): Conquered 1+ hive', 'func': lambda user: user.get('ai_devious1_conquests',0) >= 1 },
    {'name': 'E64B Devious (wk101): Conquered 2+ hives', 'func': lambda user: user.get('ai_devious1_conquests',0) >= 2 },
    {'name': 'E64C Devious (wk101): Conquered 5+ hives', 'func': lambda user: user.get('ai_devious1_conquests',0) >= 5 },
    {'name': 'E64D Devious (wk101): Conquered 10+ hives', 'func': lambda user: user.get('ai_devious1_conquests',0) >= 10 },
    {'name': 'E65A Dark Herald (wk103): Conquered 1+ hive', 'func': lambda user: user.get('ai_herald1_conquests',0) >= 1 },
    {'name': 'E65B Dark Herald (wk103): Conquered 2+ hives', 'func': lambda user: user.get('ai_herald1_conquests',0) >= 2 },
    {'name': 'E65C Dark Herald (wk103): Conquered 5+ hives', 'func': lambda user: user.get('ai_herald1_conquests',0) >= 5 },
    {'name': 'E65D Dark Herald (wk103): Conquered 10+ hives', 'func': lambda user: user.get('ai_herald1_conquests',0) >= 10 },
    {'name': 'E66A Ruckus (wk105): Conquered 1+ hive', 'func': lambda user: user.get('ai_ruckus1_conquests',0) >= 1 },
    {'name': 'E66B Ruckus (wk105): Conquered 2+ hives', 'func': lambda user: user.get('ai_ruckus1_conquests',0) >= 2 },
    {'name': 'E66C Ruckus (wk105): Conquered 5+ hives', 'func': lambda user: user.get('ai_ruckus1_conquests',0) >= 5 },
    {'name': 'E66D Ruckus (wk105): Conquered 10+ hives', 'func': lambda user: user.get('ai_ruckus1_conquests',0) >= 10 },
    {'name': 'E67A Khronic (wk106) : Conquered 1+ hive', 'func': lambda user: user.get('ai_khronic3_conquests',0) >= 1 },
    {'name': 'E67B Khronic (wk106) : Conquered 2+ hives', 'func': lambda user: user.get('ai_khronic3_conquests',0) >= 2 },
    {'name': 'E67C Khronic (wk106) : Conquered 5+ hives', 'func': lambda user: user.get('ai_khronic3_conquests',0) >= 5 },
    {'name': 'E67D Khronic (wk106) : Conquered 10+ hives', 'func': lambda user: user.get('ai_khronic3_conquests',0) >= 10 },
    {'name': 'E68A Wilder (wk107): Conquered 1+ hive', 'func': lambda user: user.get('ai_wilder3_conquests',0) >= 1 },
    {'name': 'E68B Wilder (wk107): Conquered 2+ hives', 'func': lambda user: user.get('ai_wilder3_conquests',0) >= 2 },
    {'name': 'E68C Wilder (wk107): Conquered 5+ hives', 'func': lambda user: user.get('ai_wilder3_conquests',0) >= 5 },
    {'name': 'E68D Wilder (wk107): Conquered 10+ hives', 'func': lambda user: user.get('ai_wilder3_conquests',0) >= 10 },
    {'name': 'E69A Tyrant (wk108): Conquered 1+ hive', 'func': lambda user: user.get('ai_tyrant1_conquests',0) >= 1 },
    {'name': 'E69B Tyrant (wk108): Conquered 2+ hives', 'func': lambda user: user.get('ai_tyrant1_conquests',0) >= 2 },
    {'name': 'E69C Tyrant (wk108): Conquered 5+ hives', 'func': lambda user: user.get('ai_tyrant1_conquests',0) >= 5 },
    {'name': 'E69D Tyrant (wk108): Conquered 10+ hives', 'func': lambda user: user.get('ai_tyrant1_conquests',0) >= 10 },
    {'name': 'E70A Tonca (wk109): Conquered 1+ hive', 'func': lambda user: user.get('ai_tonca3_conquests',0) >= 1 },
    {'name': 'E70B Tonca (wk109): Conquered 2+ hives', 'func': lambda user: user.get('ai_tonca3_conquests',0) >= 2 },
    {'name': 'E70C Tonca (wk109): Conquered 5+ hives', 'func': lambda user: user.get('ai_tonca3_conquests',0) >= 5 },
    {'name': 'E70D Tonca (wk109): Conquered 10+ hives', 'func': lambda user: user.get('ai_tonca3_conquests',0) >= 10 },
    {'name': 'E71A Guardian (wk110): Conquered 1+ hive', 'func': lambda user: user.get('ai_guardian3_conquests',0) >= 1 },
    {'name': 'E72B Guardian (wk110): Conquered 2+ hives', 'func': lambda user: user.get('ai_guardian3_conquests',0) >= 2 },
    {'name': 'E73C Guardian (wk110): Conquered 5+ hives', 'func': lambda user: user.get('ai_guardian3_conquests',0) >= 5 },
    {'name': 'E74D Guardian (wk110): Conquered 10+ hives', 'func': lambda user: user.get('ai_guardian3_conquests',0) >= 10 },
    {'name': 'E75A Skar (wk110): Conquered 1+ hive', 'func': lambda user: user.get('ai_skar1_conquests',0) >= 1 },
    {'name': 'E76B Skar (wk110): Conquered 2+ hives', 'func': lambda user: user.get('ai_skar1_conquests',0) >= 2 },
    {'name': 'E77C Skar (wk110): Conquered 5+ hives', 'func': lambda user: user.get('ai_skar1_conquests',0) >= 5 },
    {'name': 'E78D Skar (wk110): Conquered 10+ hives', 'func': lambda user: user.get('ai_skar1_conquests',0) >= 10 },
    {'name': 'E57A Predation (wk111) : Conquered 1+ hive', 'func': lambda user: user.get('ai_collection2_conquests',0) >= 1 },
    {'name': 'E57B Predation (wk111) : Conquered 2+ hives', 'func': lambda user: user.get('ai_collection2_conquests',0) >= 2 },
    {'name': 'E57C Predation (wk111) : Conquered 5+ hives', 'func': lambda user: user.get('ai_collection2_conquests',0) >= 5 },
    {'name': 'E57D Predation (wk111) : Conquered 10+ hives', 'func': lambda user: user.get('ai_collection2_conquests',0) >= 10 },
    {'name': 'E79A Khronic (wk112) : Conquered 1+ hive', 'func': lambda user: user.get('ai_khronic4_conquests',0) >= 1 },
    {'name': 'E79B Khronic (wk112) : Conquered 2+ hives', 'func': lambda user: user.get('ai_khronic4_conquests',0) >= 2 },
    {'name': 'E79C Khronic (wk112) : Conquered 5+ hives', 'func': lambda user: user.get('ai_khronic4_conquests',0) >= 5 },
    {'name': 'E79D Khronic (wk112) : Conquered 10+ hives', 'func': lambda user: user.get('ai_khronic4_conquests',0) >= 10 },
    {'name': 'E57A Wilder (wk113) : Conquered 1+ hive', 'func': lambda user: user.get('ai_wilder4_conquests',0) >= 1 },
    {'name': 'E57B Wilder (wk113) : Conquered 2+ hives', 'func': lambda user: user.get('ai_wilder4_conquests',0) >= 2 },
    {'name': 'E57C Wilder (wk113) : Conquered 5+ hives', 'func': lambda user: user.get('ai_wilder4_conquests',0) >= 5 },
    {'name': 'E57D Wilder (wk113) : Conquered 10+ hives', 'func': lambda user: user.get('ai_wilder4_conquests',0) >= 10 },
    {'name': 'E80A Warmonger (wk114) : Conquered 1+ hive', 'func': lambda user: user.get('ai_prophecy2_conquests',0) >= 1 },
    {'name': 'E80B Warmonger (wk114) : Conquered 2+ hives', 'func': lambda user: user.get('ai_prophecy2_conquests',0) >= 2 },
    {'name': 'E80C Warmonger (wk114) : Conquered 5+ hives', 'func': lambda user: user.get('ai_prophecy2_conquests',0) >= 5 },
    {'name': 'E80D Warmonger (wk114) : Conquered 10+ hives', 'func': lambda user: user.get('ai_prophecy2_conquests',0) >= 10 },
    {'name': 'E132A Built Weapons Factory', 'func': lambda user: user.get('weapon_factory_level',0) >= 1 },
    {'name': 'E132B Built Weapons Lab', 'func': lambda user: user.get('weapon_lab_level',0) >= 1 },
    {'name': 'E132C Built 1x Minefield', 'func': lambda user: user.get('minefield_level',0) >= 1 },
    {'name': 'E132D Crafted 1x Anti-Tracker Mine', 'func': lambda user: user.get('achievement:anti_tracker_minecraft_1',0) >= 1 },
    {'name': 'E132E Crafted 100x Anti-Tracker Mine', 'func': lambda user: user.get('achievement:anti_tracker_minecraft_100',0) >= 1 },
    {'name': 'E132F Crafted 500x Anti-Tracker Mine', 'func': lambda user: user.get('achievement:anti_tracker_minecraft_500',0) >= 1 },
    ]
}
