...
def controlapi_handle_proxyserver(args):
    ...
    elif method == 'invalidate_social_id':
...
def do_main():
    ...
    metrics_log = SpinLog.MultiLog([SpinLog.DailyJSONLog(proxy_log_dir+'/','-metrics.json'), # ALL metrics to local file
                                    ...
                                    SpinLog.AllianceHelpLogFilter(SpinNoSQLLog.NoSQLJSONLog(db_client, 'log_alliance_help')), # alliance help events to MongoDB log_alliance_help
