...
def get_csv_fields(gamedata):
    ...
    FIELDS = ["user_id", "account_creation_time", "acquisition_campaign", "acquisition_secondary", "acquisition_type", "acquisition_game_version", "age_group",
          ...
          "home_region", "squads_created", "squads_deployed", "squads_moved", "squad_attacks_launched", "quarries_conquered", "squads_attacked", "hives_attacked", "quarries_attacked", "hives_destroyed", "hive_kill_points", "hitlist_victories", "damage_inflicted_pve", "trainee_completions",
...
HOG_FIELDS = ["fb_hit_time", "kg_hit_time", "facebook_profile", "facebook_friends", "facebook_likes", "facebook_currency", "facebook_permissions", "acquisition_data", "preferences", "facebook_first_name", "facebook_friends_map", "browser_caps", "oauth_token", "fb_oauth_token", "fb_credit_balance", "fb_gamer_status", "kg_auth_token", "kg_friend_ids", "kg_avatar_url", "ag_avatar_url", "mm_auth_token", "bh_auth_token", "purchase_ui_log"]
...
PURCHASE_CATEGORY_MAP = {'MAKE_DROIDS': 'manufacturing', # dummy entry for production speedups
                         ...
                         'XSOLLA_PAYMENT': 'gamebucks', # same as BUY_GAMEBUCKS_*
...
def update_upcache_entry(user_id, driver, entry, time_now, gamedata, user_mtime = -1):
    ...
    if obj is None:
        ...
        for FIELD in ('money_purchase_history', 'gamebucks_purchase_history', 'activity',
                      'gamebucks_spent_at_time', 'gamebucks_refunded_at_time',
                      'attacks_launched_at_time', 'attacks_launched_vs_human_at_time', 'attacks_launched_vs_ai_at_time', 'attacks_suffered_at_time',
            ...
            if data.has_key('history'):
                ...
                for name in ['harvested_'+resname+'_total' for resname in gamedata['resources']] + \
                            ...
                            ['peak_gamebucks',
                             ...
                             'alliances_joined', 'alliance_id_cache', 'alliance_first_join_time', 'alliance_first_join_created',
                             'unit_donations_requested', 'units_donated', 'donated_units_received', 'alliance_gift_items_sent',
                 ...
                 "ai_chunk_588_conquests","ai_chunk_589_conquests","ai_chunk_590_conquests","ai_chunk_591_conquests",
                             ...
                             "ai_murderous4_attempted","ai_murderous4_progress","ai_murderous4_times_started","ai_murderous4_times_completed","ai_murderous4_conquests",
                ...
                for field in ['money_spent_by_day',
                              ...
                              'payer_promo_offered', 'promo_gamebucks_earned', 'payer_promo_gamebucks_earned', 'fb_gift_cards_redeemed',
                              'squads_created', 'squads_deployed', 'squads_moved', 'squad_attacks_launched', 'quarries_conquered', 'squads_attacked', 'hives_attacked', 'quarries_attacked', 'hives_destroyed', 'hive_kill_points', 'hitlist_victories', 'damage_inflicted_pve', 'trainee_completions',
                              'random_items_purchased', 'items_purchased', 'free_random_items',
                              'gift_orders_sent', 'gift_orders_received', 'gamebucks_received_from_gift_orders',
                              "gift_orders_refunded", "gift_orders_received_then_refunded", "gamebucks_refunded_from_received_gift_orders",
                              ...
                              # 'attacks_launched_at_time', # removed for bloating
