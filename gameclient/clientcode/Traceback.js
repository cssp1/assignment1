 ...
 */
Traceback.printStackTrace = function (options) {
    options = options || {guess: true};
    var ex = options.e || null, guess = !!options.guess;
    var p = new Traceback.printStackTrace.implementation(), result = p.run(ex);
...
Traceback.printStackTrace.implementation.prototype = {
    ...
    run: function(ex, mode) {
        ...
        if (mode === Traceback.printStackTrace.implementation.other) {
    ...
    mode: function(e) {
        if (e['arguments'] && e.stack) {
            return Traceback.printStackTrace.implementation.chrome;
        } else if (typeof e.message === 'string' && typeof window !== 'undefined' && window.opera) {
            // e.message.indexOf("Backtrace:") > -1 -> opera
            // !e.stacktrace -> opera
            if (!e.stacktrace) {
                return Traceback.printStackTrace.implementation.opera9; // use e.message
            }
            ...
            if (!e.stack) {
                return Traceback.printStackTrace.implementation.opera10a; // use e.stacktrace
            }
            // e.stacktrace && e.stack -> opera10b
            if (e.stacktrace.indexOf("called from line") < 0) {
                return Traceback.printStackTrace.implementation.opera10b; // use e.stacktrace, format differs from 'opera10a'
            }
            // e.stacktrace && e.stack -> opera11
            return Traceback.printStackTrace.implementation.opera11; // use e.stacktrace, format differs from 'opera10a', 'opera10b'
        } else if (e.stack) {
            return Traceback.printStackTrace.implementation.firefox;
        }
        return Traceback.printStackTrace.implementation.other;
    },
    ...
    instrumentFunction: function(context, functionName, callback) {
        ...
        context[functionName] = function instrumented() {
            callback.call(this, Traceback.printStackTrace().slice(4));
